...
from libcity.data.dataset.dataset_subclass.astgcn_air_dataset import ASTGCNAirDataset
...
from libcity.data.dataset.dataset_subclass.gman_air_dataset import GMANAirDataset
