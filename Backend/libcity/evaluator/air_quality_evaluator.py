...
class AirQualityEvaluator(AbstractEvaluator):
    ...
    def save_result(self, save_path, mode_label, filename=None):
        """
        ...
        if filename is None:  # 使用时间戳
            ...
            #            self.config['model'] + '_' + self.config['dataset'] + '_' + mode_label
            filename = self.config['model'] + '_' + self.config['dataset'] + '_' + mode_label + '_predictions'
